    ...
    <section id="about" style={{ padding: "6rem 2rem", background: "#fff" }}>
      <div style={{ maxWidth: "1200px", margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "4rem", alignItems: "center" }}>
        ...
        <div>
          ...
          <h2 style={{ fontSize: "clamp(1.75rem, 3vw, 2.25rem)", fontWeight: "500", color: "#2C1A08", marginBottom: "1.25rem", lineHeight: "1.3" }}>
            A sanctuary of elegance on the water
          </h2>
          <p style={{ color: "#5F5E5A", fontSize: "15px", lineHeight: "1.8", marginBottom: "1.25rem" }}>
          ...
          <p style={{ color: "#5F5E5A", fontSize: "15px", lineHeight: "1.8" }}>
        ...
        <div style={{
          ...
          <svg width="64" height="64" fill="none" stroke="rgba(250,234,218,0.5)" strokeWidth="1.5" viewBox="0 0 24 24">
